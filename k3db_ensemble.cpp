...
void k3db_ensemble::classify(const instance& inst, std::vector<double> &posteriorDist) {
    ...
    //            } else if (parents_[x1].size() == 1) {
    //                //  printf("PARent=1  \n");
    //                const InstanceCount totalCount1 = dist_1.xxxyCounts.xxyCounts.xyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]));
    //                if (totalCount1 == 0) {
    //                    posteriorDist[y] *= dist_1.xxxyCounts.xxyCounts.xyCounts.p(x1, inst.getCatVal(x1), y);
    //                } else {
    //                    posteriorDist[y] *= dist_1.xxxyCounts.xxyCounts.p(x1, inst.getCatVal(x1), parents_[x1][0], inst.getCatVal(parents_[x1][0]), y); // p(x1=v1|Y=y, x2=v2) using M-estimate
    //                }
    //            } else if (parents_[x1].size() == 2) {
    //                // printf("PARent=2  \n");
    //                const InstanceCount totalCount1 = dist_1.xxxyCounts.xxyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]), parents_[x1][1], inst.getCatVal(parents_[x1][1]));
    //                if (totalCount1 == 0) {
    //                    const InstanceCount totalCount2 = dist_1.xxxyCounts.xxyCounts.xyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]));
    //                    if (totalCount2 == 0) {
    //                        posteriorDist[y] *= dist_1.xxxyCounts.xxyCounts.xyCounts.p(x1, inst.getCatVal(x1), y);
    //                    } else {
    //                        posteriorDist[y] *= dist_1.xxxyCounts.xxyCounts.p(x1, inst.getCatVal(x1), parents_[x1][0], inst.getCatVal(parents_[x1][0]), y);
    ...
    //            } else if (parents_[x1].size() == 3) {
    //                // printf("PARent=2  \n");
    //                const InstanceCount totalCount = dist_1.xxxyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]), parents_[x1][1], inst.getCatVal(parents_[x1][1]), parents_[x1][2], inst.getCatVal(parents_[x1][2]));
    //                if (totalCount == 0) {
    //                    const InstanceCount totalCount01 = dist_1.xxxyCounts.xxyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]), parents_[x1][1], inst.getCatVal(parents_[x1][1]));
    //                    if (totalCount01 == 0) {
    //                        const InstanceCount totalCount0 = dist_1.xxxyCounts.xxyCounts.xyCounts.getCount(parents_[x1][0], inst.getCatVal(parents_[x1][0]));
    //                        if (totalCount0 == 0) {
